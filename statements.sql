...
-- Tu respuesta aquí
SELECT nombre, apellido FROM usuarios_lenguajes WHERE edad > 30;
...
-- Tu respuesta aquí
SELECT nombre, apellido FROM usuarios_lenguajes WHERE edad = 28;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguajes IS NOT NULL AND edad BETWEEN 25 AND 35;
...
-- Tu respuesta aquí
SELECT COUNT(*) AS users_total_languages FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT CONCAT(nombre, ' ', apellido) AS full_name FROM usuarios_lenguajes;
